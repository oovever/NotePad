...
public class SkydivingDatabase extends BaseDatabase
{
    public SkydivingDatabase(Context context)
    {
        super(context);
    }
    ...
    {
        return AppProvider.CONTENT_SKYDIVING_URI;
    }
    ...
    public Uri insert(Skydiving model)
    {
       return insert(getValues(model));
    }

    public ContentValues getValues(Skydiving model)
    {
        ContentValues values = new ContentValues();
        values.put(Table.NOTE, model.getNo());
        values.put(Table.DATE, model.getDate());
        values.put(Table.LOCATION, model.getLocation());
        values.put(Table.AIRCRAFT, model.getAircraft());
    ...
    public static class Table implements BaseColumns
    {
        ...
        public static final String TABLE_NAME   = "skydiving";
        ...
        public static final SQLiteTable TABLE =
                new SQLiteTable(TABLE_NAME)
                        ...
                        .addColumn(AIRCRAFT, Column.DataType.TEXT)
