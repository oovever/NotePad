...
public class SkydivingFragment extends BaseFragment implements LoaderManager.LoaderCallbacks<Cursor>
{
    @Bind(R.id.main_list) ListView mListView;
    @Bind(R.id.empty_view) View mEmptyView;

    private SkydivingAdapter mAdapter;

    @Override
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState)
    {
        mAdapter = new SkydivingAdapter(getActivity(), null, false);
    ...
    public Loader<Cursor> onCreateLoader(int id, Bundle args) {
        return new SkydivingDatabase(getActivity()).getCursorLoader();
    }

    public SkydivingAdapter getAdapter()
    {
        return mAdapter;
    }
